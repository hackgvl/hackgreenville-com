...
class EventApiV1Request extends FormRequest
{
    ...
    public function queryParameters()
    {
        return [
            ...
            'start_date' => [
                'description' => 'The start date for events filtering (inclusive). Future event data may be limited. Please see the [Event API docs](https://github.com/hackgvl/hackgreenville-com/blob/develop/docs/EVENTS_API.md) for information about event data limitations.',
                'example' => '2026-01-01',
            ],
            'end_date' => [
                'description' => 'The end date for events filtering (inclusive). Future event data may be limited. Please see the [Event API docs](https://github.com/hackgvl/hackgreenville-com/blob/develop/docs/EVENTS_API.md) for information about event data limitations.',
                'example' => '2100-12-31',
            ],
            'tags' => [
                'example' => null,
