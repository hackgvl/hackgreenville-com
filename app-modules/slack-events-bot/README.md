...
2. Events are filtered to show published events for the current and next week (Sunday to Saturday)
3. Messages are posted/updated in configured Slack channels
4. If a week has many events, they're split across multiple messages
5. Next week's messages are posted 5 days early (starting Tuesday)
