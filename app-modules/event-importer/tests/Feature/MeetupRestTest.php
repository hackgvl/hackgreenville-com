...
class MeetupRestTest extends DatabaseTestCase
{
    public function test_meet_up_event_is_imported_correctly(): void
    {
        ...
        $event = Event::query()->where('event_uuid', '11d0362255a5cc64693968c035892576')->firstOrFail();

        $this->assertEquals('Civic Hacking for Affordable Housing', $event->event_name);
...
HTML, $event->description);
        ...
        $this->assertEquals(1702944000, $event->active_at->utc()->unix());
        $this->assertEquals('https://www.meetup.com/code-for-the-carolinas-greenville/events/lvgwftyfcqbxb/', $event->uri);
