...
# HackGreenville The official repository for Greenville, SC's tech community website, maintained by [Code for Greenville](https://github.com/codeforgreenville).    
...
```bash  
mysql --user="root" --password -e"create database hack_greenville"  
```  
...
## Purpose Our goal is to connect people to the tech-related community in the Greenville area. We currently do this by providing information on meetups and tech organizations in the area, as well as directing people to the HackGreenville slack signup page.    
...
## Contributions welcome! This site was built with PHP 7 and Laravel.    
...
## Linkes - http://stylifyme.com/?stylify=https%3A%2F%2Fwww.greenvillesc.gov    
