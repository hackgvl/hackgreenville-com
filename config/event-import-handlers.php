...
return [
    ...
    'meetup_graphql_private_key_path' => env('EVENT_IMPORTER_MEETUP_GRAPHQL_PRIVATE_KEY_PATH', storage_path(__DIR__ . '/../app-modules/event-importer/src/Providers/Keys/meetup-graphql.pem')),
