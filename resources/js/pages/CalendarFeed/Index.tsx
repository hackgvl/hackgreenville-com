...
export default function CalendarFeedIndex({ organizations: initialOrganizations, baseUrl }: CalendarFeedIndexProps) {
  ...
  const toggleAll = () => {
    ...
    setOrganizations(orgs => orgs.map(org => ({ ...org, checked: newValue })));
  };
  ...
  return (
    <AppLayout title="Build a Calendar Feed of the events you're interested in">
      <Head>
        <meta name="description" content="Generate an iCal calendar feed to pull events for one, many, or all organizations promoted by HackGreenville into your calendar app" />
      </Head>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              >
                ...
                />
                <span className="font-medium text-slate-700">Select All / None</span>
              </div>
              ...
              <div className="space-y-2">
                {organizations.map((org) => (
                  ...
                  >
                    ...
                    <span 
                      className={`${
                        org.checked ? 'font-semibold text-slate-900' : 'font-medium text-slate-700'
                      }`}
                    >
                      {org.title}
                    </span>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-semibold text-blue-900 mb-2">How to use this feed:</h4>
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>• Click "Subscribe to Calendar Feed" to add to your default calendar app</li>
                  <li>• Or copy the URL and add it manually to your calendar application</li>
                  <li>• Select specific organizations to create a customized feed</li>
                  <li>• Your calendar will automatically update with new events</li>
                </ul>
              </div>
            </CardContent>
          </Card>
