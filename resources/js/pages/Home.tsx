...
export default function Home({ upcoming_events }: HomeProps) {
  ...
  return (
    <AppLayout title="Hackgreenville - A Developer Community in the Greenville SC Area">
      ...
      {/* Hero Section */}
      <div
        className="relative bg-gradient-to-br from-blue-900 to-purple-900 text-white"
        style={{ backgroundColor: '#1e3a8a', minHeight: '400px' }}
      >
          ...
          <div className="lg:col-span-2">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                HackGreenville is a community of "hackers" located in and around
                Greenville, SC. Our community exists to foster personal growth
                for community members through sharing and promoting local tech
                opportunities.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
              ...
              <div>
                <p className="text-lg mb-4">
                  HG is the{' '}
                  <code className="bg-gray-100 px-2 py-1 rounded">"GO TO"</code>{' '}
                  resource for discovering and connecting with Upstate SC tech
                  hackers, makers, and tinkerers.
                </p>
                <p className="text-lg mb-6">
                  Explore the site for more meetups and events, and make sure to
                  join our active{' '}
                  <a
                    href="/join-slack"
