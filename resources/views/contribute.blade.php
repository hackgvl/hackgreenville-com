        ...
        <section class="mb-14">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="relative border border-gray-100 rounded-lg p-6 hover:border-success/30 transition-colors overflow-hidden">
                    <x-lucide-hand-helping class="absolute -right-3 -top-3 w-24 h-24 text-success/[0.12]"/>
                ...
                <div class="relative border border-gray-100 rounded-lg p-6 hover:border-warning/30 transition-colors overflow-hidden">
                    <x-lucide-megaphone class="absolute -right-3 -top-3 w-24 h-24 text-warning/[0.07]"/>
                ...
                <div class="relative border border-gray-100 rounded-lg p-6 hover:border-primary/20 transition-colors overflow-hidden">
                    <x-lucide-heart-handshake class="absolute -right-3 -top-3 w-24 h-24 text-primary/[0.07]"/>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12">
            ...
            <section>
                <div class="flex items-center gap-3 mb-4">
                    <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Volunteer With</h3>
                ...
                <div>
                    <a href="/orgs/agile-learning-institute" class="group flex items-center justify-between gap-2 py-2.5 border-b border-gray-100 text-sm text-gray-700 hover:text-primary transition-colors no-underline">
                        ...
                        <x-lucide-arrow-up-right class="w-3 h-3 text-gray-200 group-hover:text-gray-400 transition-colors shrink-0"/>
                    </a>
            ...
            <section>
                <div class="flex items-center gap-3 mb-4">
                    <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Sponsor</h3>
                    <div class="h-px bg-gray-200 flex-1"></div>
                    <span class="text-xs text-gray-300 font-medium tabular-nums">6</span>
                </div>
                <div>
            ...
            <section>
                <div class="flex items-center gap-3 mb-4">
                    <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Donate To</h3>
                    <div class="h-px bg-gray-200 flex-1"></div>
