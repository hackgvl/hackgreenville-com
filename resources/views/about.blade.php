    ...
    <div class="max-w-5xl mx-auto px-4 py-8">
        ...
        <section class="mb-14">
            <div class="flex items-center gap-3 mb-6">
                <h2 class="text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">History</h2>
        ...
        <section class="mb-14">
            <div class="flex items-center gap-3 mb-6">
                <h2 class="text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Initiatives</h2>
                <div class="h-px bg-gray-200 flex-1"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="group border border-gray-100 rounded-lg p-5 hover:border-gray-200 transition-colors">
                    <div class="flex items-center gap-2.5 mb-3">
                        <div class="w-8 h-8 rounded-md bg-primary/5 flex items-center justify-center">
                            <x-lucide-hash class="w-4 h-4 text-primary"/>
                        </div>
                ...
                <div class="group border border-gray-100 rounded-lg p-5 hover:border-gray-200 transition-colors">
                    <div class="flex items-center gap-2.5 mb-3">
                        <div class="w-8 h-8 rounded-md bg-primary/5 flex items-center justify-center">
                            <x-lucide-moon class="w-4 h-4 text-primary"/>
                        </div>
                ...
                <div class="group border border-gray-100 rounded-lg p-5 hover:border-gray-200 transition-colors">
                    <div class="flex items-center gap-2.5 mb-3">
                        <div class="w-8 h-8 rounded-md bg-primary/5 flex items-center justify-center">
                            <x-lucide-flask-conical class="w-4 h-4 text-primary"/>
                        </div>
        ...
        <section class="mb-14">
            <div class="flex items-center gap-3 mb-6">
                <h2 class="text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Why HG?</h2>
                <div class="h-px bg-gray-200 flex-1"></div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
                <div>
                    <div class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Purpose</div>
                ...
                <div>
                    <div class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Mission</div>
                    <p class="text-gray-700 text-sm leading-relaxed">
                ...
                <div>
                    <div class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Vision</div>
                    <p class="text-gray-700 text-sm leading-relaxed">
        ...
        <section class="mb-14">
            <div class="flex items-center gap-3 mb-6">
                <h2 class="text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Culture &amp; Guiding Principles</h2>
                <div class="h-px bg-gray-200 flex-1"></div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                <div class="flex items-start gap-3 py-2">
                    <x-lucide-shield-check class="w-4 h-4 text-gray-300 shrink-0 mt-0.5"/>
                ...
                <div class="flex items-start gap-3 py-2">
                    <x-lucide-sprout class="w-4 h-4 text-gray-300 shrink-0 mt-0.5"/>
                    <p class="text-sm text-gray-700 leading-relaxed">
                ...
                <div class="flex items-start gap-3 py-2">
                    <x-lucide-users class="w-4 h-4 text-gray-300 shrink-0 mt-0.5"/>
                    <p class="text-sm text-gray-700 leading-relaxed">
                        We welcome all hackers, makers, and tinker types. Our community extends beyond just software.
                    </p>
                </div>
                <div class="flex items-start gap-3 py-2">
                    <x-lucide-heart class="w-4 h-4 text-gray-300 shrink-0 mt-0.5"/>
                    <p class="text-sm text-gray-700 leading-relaxed">
                        Be respectful. Egos and biases have no place here.
                    </p>
                </div>
                <div class="flex items-start gap-3 py-2">
                    <x-lucide-arrow-right-left class="w-4 h-4 text-gray-300 shrink-0 mt-0.5"/>
                    <p class="text-sm text-gray-700 leading-relaxed">
                        Pay it forward. Remember, your knowledge comes from others.
                    </p>
                </div>
                <div class="flex items-start gap-3 py-2">
                    <x-lucide-hand-helping class="w-4 h-4 text-gray-300 shrink-0 mt-0.5"/>
                    <p class="text-sm text-gray-700 leading-relaxed">
        ...
        <section class="mb-8">
            <div class="flex items-center gap-3 mb-6">
                <h2 class="text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Committee</h2>
                <div class="h-px bg-gray-200 flex-1"></div>
                <span class="text-xs text-gray-300 font-medium tabular-nums">3</span>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a href="https://www.linkedin.com/in/bogdan-kharchenko/"
                   ...
                   class="group flex items-center gap-3 py-3 px-4 border border-gray-100 rounded-lg hover:border-gray-200 transition-colors no-underline">
                    <div class="w-8 h-8 rounded-full bg-primary/5 flex items-center justify-center">
                        <x-lucide-user class="w-4 h-4 text-primary/40 group-hover:text-primary/60 transition-colors"/>
                    </div>
                    <div>
                        <div class="text-sm font-medium text-gray-700 group-hover:text-primary transition-colors">Bogdan Kharchenko</div>
                        <div class="text-xs text-gray-400 flex items-center gap-1">
                            <x-lucide-linkedin class="w-3 h-3"/> LinkedIn
                        </div>
                    </div>
                </a>
                ...
                <div class="flex items-center gap-3 py-3 px-4 border border-gray-100 rounded-lg">
                    <div class="w-8 h-8 rounded-full bg-primary/5 flex items-center justify-center">
                        <x-lucide-user class="w-4 h-4 text-primary/40"/>
                    </div>
                    <div>
